-- Fix the delete_public_board_message function to use consistent "Message deleted" format
...
BEGIN
  ...
  -- Delete the message if it belongs to this sub-user (using consistent format without brackets)
