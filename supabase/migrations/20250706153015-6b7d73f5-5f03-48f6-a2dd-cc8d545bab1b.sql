...
BEGIN
  ...
  IF v_is_recurring = true THEN
    ...
    IF v_repeat_pattern IS NULL OR 
       v_repeat_pattern NOT IN ('daily', 'weekly', 'monthly') OR
  ...
  IF p_event_id IS NULL THEN
    ...
    IF v_is_recurring = true AND 
       ...
       v_repeat_pattern IN ('daily', 'weekly', 'monthly') AND
...
-- Improve the generate_recurring_events function for better reliability
