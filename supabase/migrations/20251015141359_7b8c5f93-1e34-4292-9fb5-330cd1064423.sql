-- Drop existing edit_single_event_instance_v2 function (all overloads)
DROP FUNCTION IF EXISTS public.edit_single_event_instance_v2(uuid, uuid, jsonb, jsonb, timestamp with time zone, timestamp with time zone, text, text) CASCADE;
...
-- Recreate edit_single_event_instance_v2 with AI parameter support
