...
-- Update the save_event_with_persons function to properly handle biweekly and yearly patterns
...
-- Update the generate_recurring_events function to fix biweekly and other recurring patterns
...
BEGIN
  ...
  LOOP
    ...
    -- Stop if we've passed the repeat_until date (use <= so last one is included)
