-- Fix save_event_with_persons function signature mismatch
-- Updates function from 4 parameters to 8 parameters to support sub-user tracking
-- Required for both manual event creation and AI-generated events

DROP FUNCTION IF EXISTS public.save_event_with_persons(jsonb, jsonb, uuid, uuid);
