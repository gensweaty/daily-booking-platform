-- Fix AI channel isolation in public message access
-- Root cause: list_channel_messages_public_v2 bypasses RLS and doesn't check AI channel participation
-- Solution: For AI channels, only return messages if requester is a direct participant
