...
-- Fix the save_event_with_persons function to always include created_at
...
BEGIN
  ...
  IF p_event_id IS NULL THEN
    -- CRUCIAL FIX: Create new event with created_at column
    INSERT INTO events (
      ...
      v_repeat_pattern,
      v_repeat_until,
      NOW()  -- CRUCIAL FIX: Set created_at for main event
