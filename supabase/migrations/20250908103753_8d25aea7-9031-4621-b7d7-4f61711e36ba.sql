-- Drop and recreate functions to include edit-related fields
...
-- Recreate get_chat_messages_for_channel with edit fields
...
-- Recreate list_channel_messages_public with edit fields
