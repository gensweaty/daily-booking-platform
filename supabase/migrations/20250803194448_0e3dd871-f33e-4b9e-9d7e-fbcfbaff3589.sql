...
-- Update the save_event_with_persons function to properly handle reminder fields
...
-- Set up cron job to send reminder emails every minute
SELECT cron.schedule(
  ...
  SELECT
    net.http_post(
        url:='https://klxqmhnmqfhphirvhsmk.supabase.co/functions/v1/send-event-reminder-email',
        headers:='{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtseHFtaG5tcWZocGhpcnZoc21rIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzI0NzEzNDgsImV4cCI6MjA0ODA0NzM0OH0.9aN3ZjrRLDapZSWUNF1KAKheCM0WRBXhVvFj7gK6uMk"}'::jsonb,
