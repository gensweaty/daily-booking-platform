...
-- Step 4: Use the Most Robust Loop - Update generate_recurring_events function
...
BEGIN
  LOOP
    ...
    -- PATCH: Stop if next start is after last allowed day (inclusive)
...
-- Step 6: Update save_event_with_persons function with proper recurring call
...
BEGIN
  ...
  IF p_event_id IS NULL THEN
    ...
    -- Step 6: Generate recurring instances with exact conditions
