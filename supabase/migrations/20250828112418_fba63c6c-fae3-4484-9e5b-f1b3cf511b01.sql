...
BEGIN
    ...
    IF NOT (SELECT row_security FROM pg_tables WHERE schemaname = 'public' AND tablename = 'subscription_plans') THEN
        ALTER TABLE public.subscription_plans ENABLE ROW LEVEL SECURITY;
    END IF;
    
    IF NOT (SELECT row_security FROM pg_tables WHERE schemaname = 'public' AND tablename = 'subscriptions') THEN
        ALTER TABLE public.subscriptions ENABLE ROW LEVEL SECURITY;
    END IF;
    
    IF NOT (SELECT row_security FROM pg_tables WHERE schemaname = 'public' AND tablename = 'sub_users') THEN
        ALTER TABLE public.sub_users ENABLE ROW LEVEL SECURITY;
    END IF;
    
    IF NOT (SELECT row_security FROM pg_tables WHERE schemaname = 'public' AND tablename = 'task_comments') THEN
        ALTER TABLE public.task_comments ENABLE ROW LEVEL SECURITY;
    END IF;
    
    IF NOT (SELECT row_security FROM pg_tables WHERE schemaname = 'public' AND tablename = 'tasks') THEN
