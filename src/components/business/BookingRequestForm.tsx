...
export const BookingRequestForm = ({
  ...
  // Get the currency symbol based on the current language
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const bookingData = {
        ...
        currency_type: language, // Store the language as currency_type
        status: 'pending',
      };
      ...
      const emailNotificationPromise = (async () => {
        try {
          ...
          const notificationData = {
            ...
            currencyType: language, // Pass language as currency type
