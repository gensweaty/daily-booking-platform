...
const COPY: Record<Lang, any> = {
  en: {
    ...
    steps: [
      "Install the SMS Gateway app on the Android phone that will send your messages, and keep that phone online with an active SIM.",
      "Enter your gateway Server URL, Username and Password below — the server address is already filled in for you.",
      "Press Save, then Test connection — when you see the success message, you are ready. Your details stay saved until you remove them.",
    ],
    openApp: "Open the SMS Gateway app page",
  ...
  es: {
    ...
    steps: [
      "Instala la aplicación SMS Gateway en el teléfono Android que enviará los mensajes y mantenlo conectado con una SIM activa.",
      "Escribe abajo la URL del servidor, el Usuario y la Contraseña de tu pasarela — la dirección del servidor ya está rellenada.",
      "Pulsa Guardar y luego Probar conexión: cuando veas el mensaje de éxito, ya está listo. Tus datos se guardan hasta que los elimines.",
    ],
    openApp: "Abrir la página de la aplicación SMS Gateway",
  ...
  ka: {
    ...
    steps: [
      "დააინსტალირეთ SMS Gateway აპლიკაცია Android ტელეფონზე, რომელიც გააგზავნის შეტყობინებებს, და დატოვეთ ის ინტერნეტში აქტიური SIM-ით.",
      "ქვემოთ შეიყვანეთ სერვერის მისამართი, მომხმარებლის სახელი და პაროლი — სერვერის მისამართი უკვე შევსებულია.",
      "დააჭირეთ შენახვას და შემდეგ კავშირის შემოწმებას — როცა წარმატების შეტყობინებას დაინახავთ, მზად ხართ. მონაცემები შენახული რჩება, სანამ თავად არ წაშლით.",
    ],
    openApp: "SMS Gateway აპლიკაციის გვერდის გახსნა",
