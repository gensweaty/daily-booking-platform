  ...
  return (
    <>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full max-w-[95%] xl:max-w-[92%] 2xl:max-w-[90%] mx-auto">
        <TabsList className="grid w-full grid-cols-5 mb-2 border-2 border-border bg-background p-1 rounded-lg shadow-sm">
          <TabsTrigger 
            value="calendar" 
            className="flex items-center gap-2 text-sm sm:text-base text-foreground transition-all duration-300 hover:scale-105 active:scale-95 border-2 border-transparent hover:border-border/50 data-[state=active]:border-primary data-[state=active]:bg-primary/10 data-[state=active]:shadow-md rounded-md mx-0.5"
          >
            <motion.div
          ...
          <TabsTrigger 
            value="business" 
            className="flex items-center gap-2 text-sm sm:text-base text-foreground transition-all duration-300 hover:scale-105 active:scale-95 border-2 border-transparent hover:border-border/50 data-[state=active]:border-primary data-[state=active]:bg-primary/10 data-[state=active]:shadow-md rounded-md mx-0.5 relative"
          >
            <motion.div
              whileHover={{ rotate: 15 }}
              transition={{ duration: 0.2 }}
