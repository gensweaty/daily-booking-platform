...
export const ka: TranslationType = {
  ...
  cta: {
    title: "მზად ხართ გაზარდოთ თქვენი იზნეი?",
  ...
  events: {
    ...
    bookAppointment: "შეხვედრი დაჯვნა",
  ...
  auth: {
    ...
    verificationRequired: "მნიშვნელოვანი: რეგისრაცს შემდეგ, თქვენ უნდა დააჭიროთ ვერიფიკაციის ბმულს, რომელიც გამოგზავნილია თქვენს ელ.ფოსტაზე, რათა გააქტიუროთ თქვენი ანგარიში.",
