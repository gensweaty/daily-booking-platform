...
export const ka: TranslationType = {
  ...
  profile: {
    ...
    marketingEmails: "მარკეტინგული ელ-წერილები",
    ...
    noSubscriptionInfo: "არ არის გამოწერის ინფორმაცია",
    ...
    passwordResetEmailSent: "პაროლის აღდგენის ელ-წერილი გაიგზავნა",
    checkEmailForResetLink: "შეამოწმეთ ელ-ფოსტა აღდგენის ბმულისთვის",
    failedSendPasswordReset: "პაროლის აღდგენის ელ-წერილის გაგზავნა ვერ მოხერხდა",
