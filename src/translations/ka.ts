...
export const translations: TranslationType = {
  ...
  features: {
    ...
    booking: "ივენთი საკუთარი ბიზნესის ვებსაიტი",
    tasks: "ქვენან ბიზნესისათვის მარტება",
    crm: "თანამედროვე CRM ფუნქციონალი",
    analytics: "ავტომატიზირებული ანალიტიკა",
    website: "ქანან ბირტვი და ამოცანების მართვა",
