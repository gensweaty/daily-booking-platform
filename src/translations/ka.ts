...
export const ka: TranslationType = {
  ...
  profile: {
    ...
    failedSyncWithStripe: "Stripe-თან სინქრონიზაცია ვერ მოხერხდა. სცადეთ თავიდან.",
    ...
    failedSendPasswordReset: "პაროლის აღდგენის ელ-ფოსტის გაგზავნა ვერ მოხერხდა. სცადეთ თავიდან."
  }
};
