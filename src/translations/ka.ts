...
export const ka: TranslationType = {
  common: {
    ...
    save: "შენახვა",
    saving: "ინახება...",
    shareQRCode: "QR კოდის გაზიარება"
  },
  events: {
    ...
    phoneNumberRequired: "საჭიროა ტელეფონის ნომერი",
    validEmailRequired: "საჭიროა მოქმედი ელ.ფოსტა",
    validDatesRequired: "საჭიროა სწორი თარიღები",
  ...
  hero: {
    ...
    subtitle: "ყველაფერი ერთში - ჯავშნების სისტემა, დავალებების მართვა, CRM და ანალიტიკა",
    description: "აკონტროლეთ სამუშაო პროცესი ჩვენი მოსახერხებელი ჯავშნების კალენდრით, მძლავრი დავალებების მენეჯერით, ჭკვიანი მომხმარებლების მართვის სისტემით და ჩაშენებული ანალიტიკით. ყველაფერი რაც თქვენს ბიზნესს სჭირდება, ერთ ადგილას."
  },
  features: {
    title: "რას გთავაზობთ",
    mainTitle: "ყველაფერი რაც თქვენი ბიზნესის წარმატებისთვისაა საჭირო",
    booking: "ჯავშნები",
    tasks: "დავალებები",
    crm: "CRM",
    analytics: "ანალიტიკა",
  ...
  booking: {
    ...
    feature3: "მომხმარებლების ჯავშნების მართვა გადახდის კონტროლით",
    feature4: "ღონისძიებების ავტომატური სინქრონიზაცია CRM-თან",
    feature5: "ჯავშნის შეტყობინებები ელ.ფოსტით და დეშბორდზე",
    ...
    newRequest: "ახალი ჯავშნის მოთხოვნა მოლოდინის რეჟიმშია"
  },
  analytics: {
    title: "სრული ანალიტიკა",
    description: "თვალყური ადევნეთ თქვენს შედეგებს და ზრდას",
    feature1: "ჯავშნებისა და შემოსავლების ანალიზი",
    feature2: "მორგებული თარიღების დიაპაზონის ფილტრაცია",
    feature3: "თვიდან თვემდე შემოსავლების შედარება",
    feature4: "ინტერაქტიული ვიზუალური მეტრიკები და დიაგრამები",
    feature5: "ერთი დაწკაპუნებით Excel-ში ჩამოტვირთვა"
  },
  website: {
    title: "უფასო ვებ-გვერდი თქვენი ბიზნესისთვის",
    description: "მიიღეთ პროფესიონალური ჯავშნების ვებ-გვერდი თქვენი ბიზნესისთვის კოდის გარეშე.",
  ...
  business: {
    ...
    healthDesc: "ექიმები, თერაპევტები, ჯანმრთელობის ქოუჩები",
    sportsDesc: "პერსონალური მწვრთნელები, სპორტული მწვრთნელები, ფიტნეს ცენტრები",
    beautyDesc: "სალონები, ბარბერშოპები, ფრჩხილების სალონები, სპა ცენტრები",
    personalDesc: "კონსულტანტები, ფოტოგრაფები, საშინაო მომსახურება",
    educationDesc: "მასწავლებლები, რეპეტიტორები, ცხოვრებისეული ქოუჩები, სემინარების პროვაიდერები",
    myBusiness: "ჩემი ბიზნესი",
    businessProfile: "ბიზნეს პროფილი",
    bookingRequests: "ჯავშნის მოთხოვნები",
    pendingRequests: "მოთხოვნები ლოდინში",
    approvedRequests: "დამტკიცებული მოთხოვნები",
    rejectedRequests: "უარყოფილი მოთხოვნები",
    noPendingRequests: "არ არის მოთხოვნები ლოდინში",
    noApprovedRequests: "არ არის დამტკიცებული მოთხოვნები",
    noRejectedRequests: "არ არის უარყოფილი მოთხოვნები",
    pendingRequestsDescription: "როდესაც მომხმარებლები გააგზავნიან ჯავშნის მოთხოვნებს, ისინი გამოჩნდებიან აქ თქვენს დასამტკიცებლად.",
    ...
    notFoundDescription: "სამწუხაროდ, ვერ ვიპოვეთ ბიზნესი ამ URL-ით. გთხოვთ, შეამოწმოთ URL და სცადოთ კვლავ.",
    viewPublicPage: "საჯარო გვერდის ნახვა",
    scanQrCode: "QR კოდის სკანირება",
    qrCodeTooltip: "დაასკანერეთ ეს QR კოდი ბიზნესის გვერდის სანახავად",
    ...
    shareQRCode: "QR კოდის გაზიარება",
    shareViaSocial: "გაზიარება სოციალური მედიით",
    viewLargerQRCode: "დიდი QR კოდის ნახვა",
    copiedToClipboard: "QR კოდის ბმული კოპირებულია ბუფერში",
    share: "გაზიარება",
  ...
  auth: {
    ...
    resetPasswordCta: "გაგზავნეთ აღდგენის ბმული",
    ...
    redeemCode: "განაღდების კოდი",
    redeemCodeOptional: "განაღდების კოდი (არჩევითი)",
    enterRedeemCode: "შეიყვანეთ თქვენი განაღდების კოდი",
    sendResetLink: "გააგზავნეთ აღდგენის ბმული",
    backToSignIn: "დაბრუნება ავტორიზაციაზე",
    passwordsDoNotMatch: "პაროლები არ ემთხვევა",
    passwordTooShort: "პაროლი ძალიან მოკლეა",
    verificationRequired: "მნიშვნელოვანია: რეგისტრაციის შემდეგ, თქვენ უნდა დააწკაპუნოთ დადასტურების ბმულზე, რომელიც გამოგზავნილია თქვენს ელ.ფოსტაზე ანგარიშის გასააქტიურებლად.",
    checkEmailFolders: "გთხოვთ, შეამოწმოთ როგორც შემომავალი, ისე სპამის საქაღალდე დადასტურების ელ.წერილისთვის.",
  ...
  legal: {
    ...
    welcomeText: "კეთილი იყოს თქვენი მობრძანება SmartBookly-ში. ეს მომსახურების პირობები ('პირობები') არეგულირებს ჩვენი SaaS პლატფორმისა და სერვისების ('სერვისები') გამოყენებას. ჩვენი სერვისებით სარგებლობით თქვენ ეთანხმებით ამ პირობებს. თუ არ ეთანხმებით, გთხოვთ არ გამოიყენოთ ჩვენი სერვისები.",
    generalInfo: {
    ...
    accountSecurity: {
      ...
      requirements: [
        ...
        "დაუყოვნებლივ შეგვატყობინეთ თქვენს ანგარიშზე არაავტორიზებული წვდომის შემთხვევაში."
      ]
    }
  }
};
