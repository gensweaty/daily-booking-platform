...
export const ka: TranslationType = {
  ...
  subscription: {
    ...
    additionalSavings: "დამატებით დაზოგეთ 17% თვიურ გეგმასთან შედარებით",
    monthlyDuration: "30 დღე პრემიუმ წვდომა",
    yearlyDuration: "365 დღე პრემიუმ წვდომა",
    manageSubscription: "გამოწერის მართვა",
    chooseUpgradeRenew: "აირჩიეთ გეგმა გამოწერის განახლებისთვის ან განვითარებისთვის.",
    ...
    timeLeftInTrial: "დარჩენილი დრო საცდელში",
    timeLeftInSubscription: "დარჩენილი დრო გამოწერაში",
    days: "დღე",
    hours: "საათი",
    minutes: "წუთი",
    seconds: "წამი"
  ...
  profile: {
    ...
    subscriptionUpdatedFromStripe: "გამოწერის სტატუსი განახლდა Stripe-დან",
    syncComplete: "სინქრონიზაცია დასრულდა",
    subscriptionStatusVerified: "გამოწერის სტატუსი გადამოწმდა",
    ...
    avatarUploadSuccess: "ავატარი წარმატებით აიტვირთა",
    avatarUploadError: "ავატარის ატვირთვა ვერ მოხერხდა",
    avatarUploading: "ავატარი იტვირთება...",
    changeAvatar: "დააკლიკეთ ავატარის შესაცვლელად",
