...
export const translations: TranslationType = {
  ...
  booking: {
    ...
    feature1: "ყველა საჭირო ფუნქცია (SMS, ელფოსტა, ვებ)",
    feature2: "კალენდრის სინქრონიზაცია (გუგლ კალენდართან და სხვა)",
    feature3: "ონლაინ ჯავშნების მიღება",
    feature4: "მომხმარებლის მართვა",
    feature5: "მომხმარებლის ბაზა",
  ...
  analytics: {
    ...
    feature1: "ჯავშნების და მომხმარებლების სტატისტიკა",
    feature2: "გაყიდვების და შემოსავლის ანალიზი",
    feature3: "მომხმარებლის სტატისტიკა",
    feature4: "ვებგვერდის ვიზიტორების სტატისტიკა",
    feature5: "მონაცემების ექსპორტი Excel-ში"
  },
  crm: {
    title: "მომხმარებლების მართვა",
    description: "ადვილად მართეთ თქვენი მომხმარებლები და მათი ინფორმაცია CRM-ით",
    feature1: "მომხმარებლის ბაზა",
    feature2: "მომხმარებლის სტატუსების მართვა (ახალი, მიმდინარე, დასრულებული)",
    feature3: "მომხმარებლის ინფორმაცია",
    feature4: "მომხმარებლის სტატისტიკა",
    feature5: "ანალიზი და ანგარიშები",
  ...
  tasks: {
    ...
    description: "მარტივი ორგანიზება და კონტროლი დავალებებისა",
    feature1: "Kanban დაფა დავალებების ვიზუალურად მართვისთვის",
    feature2: "სტატუსების ცვლილება და პროგრესის მონიტორინგი",
    feature3: "პროექტების მართვა და დავალებების დანაწილება",
    feature4: "ინტეგრირებული კალენდარი დავალებებისათვის",
  ...
  website: {
    ...
    feature2: "გალერეის დამატება",
    feature3: "დომენის და ელფოსტის დამატება",
    feature4: "ონლაინ ჯავშნების შესაძლებლობა",
    feature5: "ინტეგრირებული ჯავშნების კალენდარი"
  },
  cta: {
