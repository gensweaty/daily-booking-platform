...
export const translations: TranslationType = {
  ...
  booking: {
    ...
    description: "უფასოდ მართეთ თქვენი ჯავშნების კალენდარი და მომხმარებლები",
  ...
  analytics: {
    ...
    description: "მიიღეთ სრული სურათი თქვენი ბიზნესის შესახებ და ზრდის ტენდენციები",
  ...
  crm: {
    ...
    description: "ადვილად მართეთ თქვენი მომხმარებლები და მათი ინფორმაცია CRM-ით",
  ...
  tasks: {
    ...
    description: "Kanban დაფა ვიზუალური დავალებების ორგანიზებისთვის",
  ...
  website: {
    ...
    description: "მიიღეთ პროფესიონალური ვებგვერდი თქვენი ბიზნესისათვის სრულიად უფასოდ",
