...
export const translations: TranslationType = {
  ...
  website: {
    ...
    description: 'მიიღეთ პროფესიონალური თქვენი შეხვედრების და დანიშნულებების',
    feature1: 'პროფესიონალური დიზაინი',
    feature2: 'მოგილური რეპოზისიული',
    feature3: 'დაცვანა QR კოდით',
    feature4: 'ონლაინ ჯავშნების ინტეგრაცია',
    feature5: 'ელფოსტითი შეხვედრის დადასტურების',
  },
  cta: {
