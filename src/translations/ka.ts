...
export const translations: TranslationType = {
  ...
  subscription: {
    ...
    freeWebsite: "უფასო საიტი თქვენი ბიზნესისთვის",
    unlimitedBookings: "ულიმიტო ლაივ ჯავშნები",
    unlimitedCRM: "ულიმიტო CRM მომხმარებლები",
    unlimitedTasks: "ულიმიტო ამოცანები ბორდზე",
    comprehensiveAnalytics: "ყოვლისმომცველი ანალიტიკა",
    unlimitedApprovals: "ულიმიტო ჯავშნების დასტური ემაილით",
    qrBooking: "QR კოდით სწრაფი დაჯავშნის სისტემა",
    modernDashboard: "თანამედროვე, ყველა დევაისზე ოპტიმიზირებული სამართავი პანელი"
  },
  profile: {
    title: 'პროფილი',
