...
export const translations = {
  ...
  hero: {
    ...
    description: "Take full control of your workflow with our seamless booking calendar, powerful task management, smart customer relationship management, and built-in analytics. Everything your business needs, in one place.",
  },
  features: {
    title: "What We Offer",
  ...
  crm: {
    ...
    description: "Build and maintain strong customer relationships with our CRM",
  ...
  website: {
    ...
    description: "Get a professional booking website tailored to your business needs. Showcase your services, attract more clients, and grow your brand.",
  ...
  cta: {
    ...
    subtitle: "Join Lovable today and experience the future of business management.",
  ...
  contact: {
    ...
    addressLine2: "City, Country 12345",
  ...
  auth: {
    ...
    resetPasswordError: "Error sending password reset",
    ...
    verificationRequired: "Important: After signing up, you MUST click on the verification link sent to your email to activate your account.",
  ...
  legal: {
    ...
    welcomeText: "Welcome to SmartBookly. These Terms of Service ('Terms') govern the use of our SaaS platform and services ('Services'). By accessing or using our Services, you agree to these Terms. If you do not agree, please do not use our Services.",
    generalInfo: {
  ...
  subscription: {
    ...
    ultimateSubscription: "Ultimate Plan",
  ...
  profile: {
    ...
    checkEmailForResetLink: "Please check your email for the reset link.",
