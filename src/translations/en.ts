...
export const translations: TranslationType = {
  ...
  onboarding: {
    ...
    calendarDesc: "This is your Booking Calendar. Add events, manage appointments, and keep track of your entire schedule in one place.",
    statisticsTitle: "Statistics & Analytics",
    statisticsDesc: "View detailed analytics about your bookings, income, and overall business performance. Export reports to Excel anytime.",
    tasksTitle: "Task Management",
    tasksDesc: "Organize your work with a Kanban board. Create tasks, set deadlines, and assign them to your team members.",
    crmTitle: "Customer Management (CRM)",
    crmDesc: "Your customer database. Add clients, track payments, manage relationships, and import data from Excel.",
    businessTitle: "Business Page",
    businessDesc: "Set up your public booking page so clients can request appointments directly. Share it via link or QR code.",
