...
export const translations: TranslationType = {
  ...
  publicBoard: {
    ...
    makePublic: "Make Board Public",
    publicDescription: "Allow external users to access this board",
    magicWord: "Magic Word",
    enterMagicWord: "Enter magic word",
    magicWordDescription: "External users need this word to access the board",
    ...
    enterCredentials: "Enter your credentials to access this board",
    fullName: "Full Name",
    enterFullName: "Enter your full name",
    fillAllFields: "Please fill all required fields",
    invalidMagicWord: "Invalid magic word",
    errorCreatingAccess: "Error creating access",
    accessGranted: "Access granted successfully",
    enterBoard: "Enter Board",
    boardNotFound: "Board not found or is not active",
  },
  bookings: {
