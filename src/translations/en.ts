export const enTranslations = {
  ...
  "dashboard.subtitle": "Your all-in-one hub for tasks, bookings, CRM, and insights.",
  ...
  "dashboard.threeMonthIncome": "Three Month Income",
  ...
  "dashboard.exportSuccessMessage": "Data has been exported to Excel successfully",

  // Booking
  "booking.title": "Smart Booking",
  "booking.description": "Efficiently manage your appointments",
  "booking.feature1": "Multiple calendar views",
  "booking.feature2": "Customizable time slots",
  "booking.feature3": "Payment tracking",
  "booking.feature4": "Automatic syncing",
  ...
  "analytics.feature3": "Monthly income comparison",
  "analytics.feature4": "Interactive visual metrics",
  "analytics.feature5": "One-click Excel export",

  // Tasks
  "tasks.title": "Task Management",
  "tasks.description": "Stay organized and productive",
  "tasks.feature1": "Kanban board for visual organization",
  "tasks.feature2": "Task status and progress tracking",
  "tasks.feature3": "Efficient prioritization",
  "tasks.feature4": "Drag-and-drop functionality",
  "tasks.feature5": "Quick task notes",
  ...
  "crm.description": "Build and maintain strong customer relationships",
  ...
  "crm.feature5": "One-click Excel export of all displayed data",
