...
export const translations: TranslationType = {
  ...
  features: {
    ...
    smsNotifications: "SMS Automáticos",
    telegramAi: "IA en Telegram",
    embedBooking: "Reservas Integradas",
    ai: "Asistente IA",
  ...
  website: {
    ...
    feature6: "Reservas limitadas a su horario laboral real",
    feature7: "Apruebe solicitudes con un mensaje personal al cliente",
  },
  teamChat: {
  ...
  smsNotifications: {
    title: "Notificaciones SMS Automáticas",
    description: "Los SMS se leen en minutos y SmartBookly los envía por usted. Conecte su propio teléfono Android con su SIM y cada confirmación, rechazo, aviso de solicitud y recordatorio de cita puede enviarse por SMS automáticamente, sin coste por mensaje por nuestra parte.",
    feature1: "SMS automáticos para reservas aprobadas, rechazadas y recibidas",
    feature2: "Recordatorios de cita enviados al cliente antes de su visita",
    feature3: "Aviso inmediato a su propio teléfono con cada nueva solicitud",
    feature4: "Plantillas editables con etiquetas @name, @business, @date y @time",
    feature5: "SMS masivos a sus contactos del CRM: hasta 500 mensajes por envío",
    feature6: "Enviados desde su número y su SIM, así las respuestas le llegan a usted",
  },
  telegramAi: {
    title: "Asistente de IA en Telegram y Multicanal",
    description: "Su asistente de SmartBookly no vive solo en el panel. Escríbale por Telegram para crear eventos, tareas, recordatorios y clientes, envíe notas de voz o documentos para analizarlos al instante y reciba cada recordatorio donde realmente está.",
    feature1: "Converse con su asistente directamente en Telegram",
    feature2: "Envíe mensajes de voz: se transcriben y se ejecutan",
    feature3: "Suba imágenes y documentos para análisis con IA",
    feature4: "Recordatorios en Telegram, correo y el panel",
    feature5: "Pida una captura de cualquier tablero y recíbala en el chat",
    feature6: "Conversación sincronizada entre el panel y Telegram",
  },
  embedBooking: {
    title: "Integre las Reservas en su Propio Sitio Web",
    description: "¿Ya tiene un sitio web? Inserte su calendario de reservas de SmartBookly con una sola línea de código: las solicitudes llegan a su panel igual que desde su página de SmartBookly.",
    feature1: "Fragmento iframe de una línea, copiar y pegar — sin programar",
    feature2: "Tema claro u oscuro para combinar con su sitio",
    feature3: "Opción de idioma: inglés, español o georgiano",
    feature4: "Marca opcional con su logotipo y nombre comercial",
    feature5: "Solo se ofrecen las horas laborales reales a los clientes",
  },
  cta: {
  ...
  onboarding: {
    welcomeTitle: "¡Bienvenido a SmartBookly!",
    welcomeDescription: "Permítenos darte un recorrido rápido por tu panel. Te mostraremos dónde está todo para que puedas empezar de inmediato.",
    startTour: "Iniciar Recorrido",
    skipTour: "Quizás Después",
    next: "Siguiente",
    previous: "Atrás",
    skip: "Omitir",
    finish: "¡Entendido!",
    calendarTitle: "📅 Calendario de Reservas",
    calendarDesc: "Esta es tu pestaña de Calendario. Haz clic aquí para ver y gestionar tu agenda. Puedes ver las citas por día, semana o mes.",
    calendarAddTitle: "➕ Cómo Añadir un Evento",
    calendarAddDesc: "Para añadir un evento, haz clic en el botón '+ Añadir Evento' en la esquina superior derecha del calendario, o haz clic directamente en cualquier celda de fecha. Completa el nombre del cliente, la hora y los detalles.",
    statisticsTitle: "📊 Estadísticas y Análisis",
    statisticsDesc: "Haz clic en la pestaña Estadísticas para ver análisis detallados de tus reservas e ingresos. Filtra por rango de fechas y exporta informes a Excel con el botón de descarga.",
    tasksTitle: "📋 Gestión de Tareas",
    tasksDesc: "Haz clic en la pestaña Tareas para abrir tu tablero Kanban con columnas: Por hacer, En progreso y Completado.",
    tasksAddTitle: "✏️ Cómo Añadir y Mover Tareas",
    tasksAddDesc: "Haz clic en '+ Añadir Tarea' para crear una nueva tarea. Establece título, fecha límite y asígnala. Para cambiar el estado, arrastra entre columnas o usa el menú desplegable de estado.",
    crmTitle: "👥 Gestión de Clientes (CRM)",
    crmDesc: "Haz clic en la pestaña CRM para acceder a tu base de datos de clientes.",
    crmAddTitle: "➕ Cómo Añadir Clientes",
    ...
    profileDesc: "Haz clic en tu botón de Perfil en la esquina superior derecha para personalizar avatar, idioma, tema y gestionar tu suscripción.",
  }
};
