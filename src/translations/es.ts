...
export const translations: TranslationType = {
  ...
  events: {
    ...
    requestSubmittedDesc: "Su solicitud de reserva ha sido enviada exitosamente.",
    requestError: "Error de Solicitud",
    requestErrorDesc: "Hubo un error al enviar su solicitud. Por favor, inténtelo de nuevo.",
    ...
    validDates: "Por favor, seleccione fechas de inicio y fin válidas",
    ...
    notesPlaceholder: "Notas adicionales o solicitudes especiales...",
    ...
    email: "Correo Electrónico",
    participantNotes: "Notas sobre este participante",
  },
  contact: {
    email: "Correo electrónico",
