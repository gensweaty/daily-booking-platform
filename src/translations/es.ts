...
export const es: TranslationType = {
  ...
  contact: {
    ...
    error: "Error",
    errorDesc: "Se produjo un error al enviar su mensaje. Por favor, inténtelo de nuevo."
  },
  calendar: {
  ...
  profile: {
    ...
    subscriptionUpdatedFromStripe: "Estado de suscripción actualizado desde Stripe",
