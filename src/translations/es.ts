...
export const translations: TranslationType = {
  ...
  hero: {
    ...
    subtitle: "Solución Todo-en-Uno - Reservas de Eventos, Gestión de Tareas, CRM y Analíticas",
    description: "Toma el control completo de tu flujo de trabajo con nuestro calendario de reservas fluido, gestión de tareas poderosa, gestión inteligente de relaciones con clientes y analíticas integradas. Todo lo que tu negocio necesita, en un solo lugar.",
  },
  features: {
    ...
    automatedAnalytics: "Analíticas de Rendimiento Automatizadas",
  ...
  booking: {
    ...
    feature5: "Notificaciones de reserva por email y panel",
  ...
  analytics: {
    ...
    feature1: "Analíticas de reservas e ingresos",
    ...
    feature5: "Descarga Excel con un clic"
  },
  crm: {
    ...
    feature5: "Descarga Excel con un clic de todos los datos mostrados",
    notPaid: "No Pagado",
    ...
    comment: "Comentario",
    commentPlaceholder: "Agrega un comentario sobre este cliente",
    create: "Crear",
    cancel: "Cancelar",
  ...
  website: {
    title: "Sitio Web Gratis para tu negocio",
  ...
  business: {
    ...
    educationDesc: "Maestros, tutores, life coaches, proveedores de talleres",
    ...
    notFoundDescription: "Lo siento, no pudimos encontrar un negocio con esta URL. Por favor verifica la URL e intenta de nuevo.",
  ...
  events: {
    ...
    eventNotes: "Notas",
    addEventNotes: "Agrega notas sobre tu solicitud de reserva",
  ...
  legal: {
    ...
    welcomeText: "Bienvenido a SmartBookly. Estos Términos de Servicio ('Términos') rigen el uso de nuestra plataforma SaaS y servicios ('Servicios'). Al acceder o usar nuestros Servicios, aceptas estos Términos. Si no estás de acuerdo, por favor no uses nuestros Servicios.",
    generalInfo: {
  ...
  profile: {
    ...
    failedRefreshSubscription: "Error al actualizar el estado de suscripción",
    syncSuccessful: "Sincronización Exitosa",
    subscriptionUpdatedFromStripe: "Tu estado de suscripción ha sido actualizado desde Stripe",
