...
export const translations: TranslationType = {
  ...
  onboarding: {
    ...
    calendarDesc: "Este es tu Calendario de Reservas. Añade eventos, gestiona citas y lleva el control de toda tu agenda en un solo lugar.",
    statisticsTitle: "Estadísticas y Análisis",
    statisticsDesc: "Ve análisis detallados sobre tus reservas, ingresos y rendimiento general del negocio. Exporta informes a Excel.",
    tasksTitle: "Gestión de Tareas",
    tasksDesc: "Organiza tu trabajo con un tablero Kanban. Crea tareas, establece plazos y asígnalas a los miembros de tu equipo.",
    crmTitle: "Gestión de Clientes (CRM)",
    crmDesc: "Tu base de datos de clientes. Añade clientes, rastrea pagos, gestiona relaciones e importa datos desde Excel.",
    businessTitle: "Página de Negocio",
    businessDesc: "Configura tu página pública de reservas para que los clientes puedan solicitar citas directamente. Compártela por enlace o código QR.",
