...
export const SEO_CONFIG = {
  ...
  pages: {
    contact: {
      en: { title: "Contact Us - Smartbookly", description: "Get in touch with Smartbookly for business productivity solutions" },
      es: { title: "Contáctanos - Smartbookly", description: "Ponte en contacto con Smartbookly para soluciones de productividad empresarial" },
      ka: { title: "დაგვიკავშირდით - Smartbookly", description: "დაუკავშირდით Smartbookly-ს ბიზნეს პროდუქტიულობის გადაწყვეტებისთვის" }
    },
    legal: {
      en: { title: "Legal - Smartbookly", description: "Terms of service and privacy policy for Smartbookly" },
      es: { title: "Legal - Smartbookly", description: "Términos de servicio y política de privacidad de Smartbookly" },
      ka: { title: "იურიდიული - Smartbookly", description: "მომსახურების პირობები და კონფიდენციალურობის პოლიტიკა Smartbookly-სთვის" }
    }
  }
};

export const BUSINESS_TYPES = [
  "salon", "restaurant", "clinic", "gym", "spa", "dental", "veterinary", 
  "consulting", "photography", "legal", "accounting", "coaching", "therapy"
];
